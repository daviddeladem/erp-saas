                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price"><?php echo e(env('CURRENCY_SYMBOL').$value->price); ?><small
                                ...
                                <ul class="list-unstyled my-3">
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                <?php echo e($value->max_customers != 0 ? 'checked' : ""); ?>>
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->max_customers); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                <?php echo e($value->max_venders != 0 ? 'checked' : ""); ?>>
                                            <label class="form-check-label" for="customCheckc1"><?php echo e($value->max_venders); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                <?php echo e($value->account != 0 ? 'checked' : ""); ?>>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                <?php echo e($value->crm != 0 ? 'checked' : ""); ?>>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->crm ==1 ? 'Enable' : 'Disable'); ?> <?php echo e(__('CRM')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                <?php echo e($value->hrm != 0 ? 'checked' : ""); ?>>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->hrm ==1 ? 'Enable' : 'Disable'); ?> <?php echo e(__('HRM')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                <?php echo e($value->project != 0 ? 'checked' : ""); ?>>
                                            <label class="form-check-label"
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                <?php echo e($value->pos != 0 ? 'checked' : ""); ?>>
                                            <label class="form-check-label"
                                                for="customCheckc1"><?php echo e($value->pos ==1 ? 'Enable' : 'Disable'); ?> <?php echo e(__('POS')); ?></label>
                                        </div>
                                    </li>
                                ...
                                <div class="d-grid">
                                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary rounded-pill"><?php echo e(__('Start with Starter')); ?> <i data-feather="log-in" class="ms-2"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /Users/macbookpro/Downloads/main-file/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>